        ...
        <div class="navbar-vertical-footer-offset">
            ...
            <div class="navbar-vertical-content">
                <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                    ...
                    <span class="dropdown-header mt-3">@lang('Plan Manage')</span>
                    <small class="bi-three-dots nav-subtitle-replacer"></small>
                    <div class="nav-item">
                        <a class="nav-link {{menuActive(['admin.plan.list', 'admin.plan.create', 'admin.plan.edit'])}}"
                           href="{{ route('admin.plan.list') }}" data-placement="left">
                            <i class="bi bi-box nav-icon"></i>
                            <span class="nav-link-title">@lang("Plans")</span>
                        </a>
                    </div>
                    <div class="nav-item">
                        <a class="nav-link {{menuActive(['admin.plan.sold.list', 'admin.search.plan.sold'])}}"
                           href="{{ route('admin.plan.sold.list') }}" data-placement="left">
                            <i class="bi bi-card-list nav-icon"></i>
                            <span class="nav-link-title">@lang("Sold Plan")</span>
                        </a>
                    </div>

                    <span class="dropdown-header mt-3">@lang('Travel Manage')</span>
                    <small class="bi-three-dots nav-subtitle-replacer"></small>
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ menuActive(['admin.all.amenity','admin.amenity.create','admin.amenity.edit']) }}"
                    ...
                    <div class="nav-item">
                        <a class="nav-link dropdown-toggle {{ menuActive(['admin.all.package.category', 'admin.package.category.add','admin.package.category.edit', 'admin.all.package', 'admin.package.add','admin.package.edit*','admin.package.seo'], 3) }}"
                           ...
                           aria-controls="navbarVerticalPackageMenu">
                            ...
                            <span class="nav-link-title">@lang('Package')</span>
                        </a>
                        <div id="navbarVerticalPackageMenu"
                            ...
                            <a class="nav-link {{ menuActive(['admin.all.package.category', 'admin.package.category.add','admin.package.category.edit']) }}"
                               href="{{ route('admin.all.package.category') }}">@lang('Category')</a>

                            <a class="nav-link {{ menuActive(['admin.all.package','admin.package.edit*','admin.package.seo']) }}"
                    ...
                    <span class="dropdown-header mt-3">@lang('Promotion Manage')</span>
                    <small class="bi-three-dots nav-subtitle-replacer"></small>
                    ...
                    <div class="nav-item" {{ menuActive(['admin.vendor.kyc.requests','admin.vendor.kyc.form'], 3) }}>
                        <a class="nav-link dropdown-toggle collapsed" href="#navbarVerticalVendorKycRequestMenu"
                           role="button"
                           data-bs-toggle="collapse" data-bs-target="#navbarVerticalVendorKycRequestMenu"
                           aria-expanded="false"
                           aria-controls="navbarVerticalVendorKycRequestMenu">
                            <i class="bi bi-person-lines-fill nav-icon"></i>
                            <span class="nav-link-title">@lang("Vendor KYC")</span>
                        </a>
                        <div id="navbarVerticalVendorKycRequestMenu"
                             class="nav-collapse collapse {{ menuActive(['admin.vendor.kyc.requests','admin.vendor.kyc.form'], 2) }}"
                             data-bs-parent="#navbarVerticalVendorKycRequestMenu">

                            <a class="nav-link {{ menuActive(['admin.vendor.kyc.form']) }}"
                               href="{{ route('admin.vendor.kyc.form') }}">
                                @lang('Form')
                            </a>
                            <a class="nav-link {{ menuActive(['admin.vendor.kyc.requests']) }}"
                               href="{{ route('admin.vendor.kyc.requests', ['type' => 1]) }}">
                                @lang('Requests')
                            </a>
                        </div>
                    </div>
                    ...
                    <span class="dropdown-header mt-3">@lang("Others Settings")</span>
                    <div class="nav-item">
                    ...
                    <span class="dropdown-header mt-3">@lang("Appearance")</span>
                    <small class="bi-three-dots nav-subtitle-replacer"></small>
                    <div id="navbarVerticalThemeMenu">
                        <div class="nav-item">
                            <a class="nav-link {{ menuActive(['admin.home.style']) }}"
                               href="{{ route('admin.home.style') }}" data-placement="left">
                                <i class="fa-light fa-house nav-icon"></i>
                                <span class="nav-link-title">@lang('Home Variations')</span>
                            </a>
                        </div>
                        <div class="nav-item">
                            <a class="nav-link {{ menuActive(['admin.list.style']) }}"
                               href="{{ route('admin.list.style') }}"
                               data-placement="left">
                                <i class="fa-light fa-shopping-bag nav-icon"></i>
                                <span class="nav-link-title">@lang('Tour Variations')</span>
                            </a>
                        </div>
                        <div class="nav-item">
